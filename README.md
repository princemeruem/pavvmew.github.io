...
<section class="gifts">
    ...
    <p>
    Победитель получает милый брелок с котиком, лапку-сквиш, носочки и ручную открытку.
    Отправка по РФ, для других стран — арт в моем стиле на любую выбранную тобой тему (или мной) &lt;3
   </p>
...
<section class="rewards">
    ...
    <p>Проголосовать за своего любимчика можно будет в виде опроса во время стрима, не проморгай =)</p>
</section>
