...
<section>
    ...
    <p>Но, это еще не все. Пока остальные веселят тебя в игре, ты можешь также поучаствовать в активности "лучший чаттерс" - здесь твоя задача проста: делай клипы забавных моментов, оригинально шути и комментируй происходящее, заливай свои баллы канала и активно проявляй себя. В конце стрима я и модератор определят победителя (если ты также играешь с нами в кастомке, у тебя есть возможность залутать несколько наград).</p>
</section>

<section class="features">
    <h3>Особенности</h3>
    <p>Наши игры будет комментировать новогодний кролик, только он совсем не смыслит ничего в наших играх, поэтому будет выступать символом веселья и радости. Ему также поручено оценивать матчи и помогать мне выставлять предварительный рейтинг самых крутых игроков, однако конечный выбор победителя остается также за зрителем!</p>
    <p>За СЕБЯ голосовать нельзя :Р</p>
    <p>В случае, если у игроков будет равное количество симпатий, мы попросим кандидатов на подарок рассказать нам новогодний стих или спеть новогоднюю песню.</p>
</section>
